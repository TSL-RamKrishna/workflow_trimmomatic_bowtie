...
rule analysis:
    input:
        expand(["results/trimmomatic/{sample}/R1_paired.fastq",
                "results/trimmomatic/{sample}/R1_unpaired.fastq",
                "results/trimmomatic/{sample}/R2_paired.fastq",
                "results/trimmomatic/{sample}/R2_unpaired.fastq"],
